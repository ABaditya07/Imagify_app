                ...
                <div className="grid grid-cols-2 md:grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://github.com/ABaditya07/Imagify_app" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={assets.github_icon} alt="github" className="w-4 h-4" />
                            </a>
                            <a href="https://www.linkedin.com/in/aditya-bhure-729882258/" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={assets.linkedin_icon} alt="linkedin" className="w-4 h-4" />
                            </a>
                            <a href="https://www.instagram.com/ab_aditya07/?hl=en" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
